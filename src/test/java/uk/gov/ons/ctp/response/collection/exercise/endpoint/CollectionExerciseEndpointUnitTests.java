...
public class CollectionExerciseEndpointUnitTests {
    private static final Logger log = LoggerFactory.getLogger(CollectionExerciseEndpointUnitTests.class);
    ...
    private static final String SUPPLEMENTARY_DATASET_JSON = "{\"survey_id\":\"001\",\"period_id\":\"220823\",\"form_types\":[\"0001\",\"1234\"],"
    ...
    public void setUp() throws Exception {
        ...
        this.mockCollectionExerciseMvc = MockMvcBuilders.standaloneSetup(colectionExerciseEndpoint)
                .setHandlerExceptionResolvers(mockAdviceFor(RestExceptionHandler.class))
                .setMessageConverters(new MappingJackson2HttpMessageConverter(new CustomObjectMapper()))
                .build();

        this.textPlainMock = MockMvcBuilders.standaloneSetup(colectionExerciseEndpoint)
                .setHandlerExceptionResolvers(mockAdviceFor(RestExceptionHandler.class))
                .build();
    ...
    public void findCollectionExercisesForSurvey() throws Exception {
        ...
        ResultActions actions = mockCollectionExerciseMvc.perform(
    ...
    /**
     * Tests if collection exercises found for list of surveys. Returned in a Json
     * dictionary
     *
     * @throws Exception
     */
     ...
     */
    @Test
    public void findCollectionExerciseGetEventsThrowsCTPExceptionSuccessfullyRetrievesCollectionExercise()
            throws Exception {
        when(collectionExerciseService.findCollectionExercise(COLLECTIONEXERCISE_ID1))
                .thenReturn(collectionExerciseResults.get(0));
        when(surveyService.findSurvey(UUID.fromString("31ec898e-f370-429a-bca4-eab1045aff4e")))
    ...
    public void linkSampleUnitsPut() throws Exception {
        ...
        SampleLinkDTO sampleLinkDTO1 = new SampleLinkDTO(SAMPLE_SUMMARY_ID1.toString(),
                COLLECTIONEXERCISE_ID1.toString());
        SampleLinkDTO sampleLinkDTO2 = new SampleLinkDTO(SAMPLE_SUMMARY_ID2.toString(),
                COLLECTIONEXERCISE_ID1.toString());
    ...
    public void testPatchCollectionExerciseExerciseRef() throws Exception {
        ...
        MockHttpServletRequestBuilder builder = put(
                String.format("/collectionexercises/%s/exerciseRef", uuid.toString()), new Object[0])
    ...
    public void testPatchCollectionExerciseName() throws Exception {
        ...
        MockHttpServletRequestBuilder builder = put(String.format("/collectionexercises/%s/name", uuid.toString()),
                new Object[0])
                .content(newName)
                .contentType(MediaType.TEXT_PLAIN);
    ...
    public void testPatchCollectionExerciseSurveyId() throws Exception {
        ...
        MockHttpServletRequestBuilder builder = put(String.format("/collectionexercises/%s/surveyId", uuid.toString()),
                new Object[0])
                .content(newSurveyId)
                .contentType(MediaType.TEXT_PLAIN);
    ...
    public void testDeleteCollectionExercise() throws Exception {
        ...
        MockHttpServletRequestBuilder builder = MockMvcRequestBuilders
                .delete(String.format("/collectionexercises/%s", uuid.toString()));
    ...
    /**
     * Test to update collection exercise event timestamp(date) linked to a
     * collection exercise
     *
     * @throws Exception exception thrown
     */
    ...
    public void testUpdateEvent() throws Exception {
        ...
        MockHttpServletRequestBuilder builder = put(
                String.format("/collectionexercises/%s/events/End", uuid.toString()), new Object[0])
                .content(newDate)
                .contentType(MediaType.TEXT_PLAIN);
    ...
    public void testPutEventError() throws Exception {
        ...
        ResultActions actions = textPlainMock.perform(
    ...
    /**
     * Test that creating an event via POST raises an error gives us the right
     * output
     *
     * @throws Exception
     */
