...
public class CollectionInstrumentSvcClientImpl implements CollectionInstrumentSvcClient {
  ...
  public List<CollectionInstrumentDTO> requestCollectionInstruments(String searchString) {
    ...
    List<CollectionInstrumentDTO> collectionInstrumentDTOList = collectionInstrumentSvcClientRestTemplate.getResourcesWithJsonParam(path, CollectionInstrumentDTO[].class, null, queryParams, searchString);
